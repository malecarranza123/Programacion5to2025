...
let gameOver = false;
let score = 0;
let lastSpeedIncrease = 0;   // Variable de control para aumentar la velocidad
let highScore = 0;  // Puntuación máxima alcanzada
...
// Botón adicional para reiniciar el juego manualmente en cualquier momento
